      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8 relative z-10 space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
          ...
          <div className="space-y-2.5 sm:space-y-3 text-center md:text-left max-w-2xl">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-[10px] sm:text-xs font-bold uppercase tracking-wider">
              <Sparkles className="w-3 h-3" />
              <span>ቀላል ገበያ — የኢትዮጵያ ከተሞች ማርኬትፕሌስ</span>
            </div>

            <h1 className="text-lg sm:text-2xl lg:text-3xl font-extrabold tracking-tight leading-snug text-white">
              {displayTitle}
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5 pt-1">
              <button
                onClick={onExplore}
                className="flex items-center gap-2 bg-orange-500 hover:bg-orange-400 text-slate-950 font-bold px-4 py-2 rounded-xl shadow-lg shadow-orange-500/20 transition-all hover:scale-105 active:scale-95 text-xs"
              >
                <span>{getTranslation(lang, 'shopNow')}</span>
                <ArrowRight className="w-3.5 h-3.5" />
              </button>

              <div className="flex items-center gap-1.5 text-[11px] sm:text-xs font-medium text-slate-300 bg-slate-900/90 px-3 py-2 rounded-xl border border-slate-800 backdrop-blur-md">
          ...
          <div className="bg-slate-900/80 p-3 sm:p-4 rounded-2xl border border-orange-500/20 shadow-xl backdrop-blur-md space-y-2.5 w-full md:w-72 shrink-0">
            <div className="flex items-center gap-2 text-[11px] sm:text-xs font-bold uppercase tracking-wider text-orange-400 border-b border-slate-800/80 pb-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 gap-2">
              <a
                ...
                className="flex items-center gap-2.5 p-2 rounded-xl bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 transition-all group"
              >
                <div className="w-7 h-7 rounded-lg bg-orange-500/10 text-orange-400 flex items-center justify-center font-bold group-hover:scale-110 transition-transform shrink-0">
                  <PhoneCall className="w-3 h-3" />
                </div>
                <div className="truncate">
                  <p className="text-[9px] uppercase font-bold text-slate-400">ስልክ (Phone)</p>
                  <p className="text-[11px] sm:text-xs font-bold text-white truncate">{supportPhone}</p>
                </div>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-2.5 p-2 rounded-xl bg-slate-800/60 hover:bg-slate-800 border border-slate-700/50 transition-all group"
              >
                <div className="w-7 h-7 rounded-lg bg-sky-500/10 text-sky-400 flex items-center justify-center font-bold group-hover:scale-110 transition-transform shrink-0">
                  <Send className="w-3 h-3" />
                </div>
                <div className="truncate">
                  <p className="text-[9px] uppercase font-bold text-slate-400">ቴሌግራም</p>
                  <p className="text-[11px] sm:text-xs font-bold text-sky-400 truncate">{telegramHandle}</p>
                </div>
              </a>
            </div>
          </div>
